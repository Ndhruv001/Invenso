...
async function ensureSales(parties) {
  ...
  if (toCreate.length) {
    console.log(
      `➡️ Creating ${toCreate.length} Sale rows (invoiceNumbers ${toCreate.map(x => x.invoiceNumber).join(", ")})`
    );
...
async function ensurePurchases(parties) {
  ...
  if (toCreate.length) {
    console.log(
      `➡️ Creating ${toCreate.length} Purchase rows (invoiceNumbers ${toCreate.map(x => x.invoiceNumber).join(", ")})`
    );
  ...
  const payments = [
    {
      ...
      partyId: allParties[0]?.id || 1,
      type: "RECEIVED",
      amount: 2500.0,
      paymentReference: "INV-1001",
      remark: "Sale payment received",
      referenceType: "SALE",
      referenceId: 101,
      paymentMode: "CASH"
    },
    {
      ...
      partyId: allParties[1]?.id || 1,
      type: "PAID",
      amount: 1800.5,
      paymentReference: "PUR-2001",
    ...
    },
    {
      ...
      partyId: allParties[2]?.id || 1,
      type: "RECEIVED",
      amount: 3200.0,
      paymentReference: "INV-1002",
      remark: "Advance from customer",
      referenceType: "SALE",
      referenceId: 102,
      paymentMode: "UPI"
    },
    {
      ...
      type: "PAID",
      amount: 750.0,
      paymentReference: "EXP-3001",
      remark: "Transport fuel expense",
    ...
    },
    {
      ...
      type: "PAID",
      amount: 980.0,
      paymentReference: "PUR-2002",
      remark: "Advance for material",
      referenceType: "PURCHASE",
      referenceId: 202,
      paymentMode: "UPI"
    },
    ...
    },
    {
      ...
      type: "PAID",
      amount: 2600.0,
      paymentReference: "PUR-2003",
      remark: "Purchase settlement",
      referenceType: "PURCHASE",
      referenceId: 203,
      paymentMode: "CHEQUE"
    },
    {
      ...
      type: "RECEIVED",
      amount: 4500.0,
      paymentReference: "INV-1005",
      remark: "Final invoice payment",
      referenceType: "SALE",
      referenceId: 105,
      paymentMode: "ONLINE"
    },
    {
      ...
      type: "PAID",
      amount: 1250.0,
      paymentReference: "EXP-3002",
      remark: "Transport maintenance",
      referenceType: "TRANSPORT",
      referenceId: null,
      paymentMode: "CASH"
    },
    ...
    },
    {
      ...
      type: "PAID",
      amount: 2050.0,
      paymentReference: "PUR-2004",
      remark: "Material purchase",
      referenceType: "PURCHASE",
      referenceId: 204,
      paymentMode: "BANK_TRANSFER"
    },
    {
      ...
      type: "RECEIVED",
      amount: 2950.0,
      paymentReference: "INV-1007",
      remark: "Customer advance",
      referenceType: "SALE",
      referenceId: 107,
      paymentMode: "UPI"
    },
    {
      ...
      type: "PAID",
      amount: 850.0,
      paymentReference: "PUR-2005",
      remark: "Misc material cost",
      referenceType: "PURCHASE",
      referenceId: 205,
      paymentMode: "CASH"
    },
    {
      ...
      type: "RECEIVED",
      amount: 5100.0,
      paymentReference: "INV-1008",
      remark: "Final payment cleared",
      referenceType: "SALE",
      referenceId: 108,
      paymentMode: "ONLINE"
    },
    {
      ...
      type: "PAID",
      amount: 1900.0,
      paymentReference: "EXP-3003",
      remark: "Driver wage payment",
      referenceType: "TRANSPORT",
      referenceId: null,
      paymentMode: "CASH"
    },
    {
      ...
      type: "RECEIVED",
      amount: 3400.0,
      paymentReference: "INV-1009",
      remark: "Customer partial",
      referenceType: "SALE",
      referenceId: 109,
      paymentMode: "CARD"
    },
    {
      ...
      type: "PAID",
      amount: 2200.0,
      paymentReference: "PUR-2006",
      remark: "Transport materials",
      referenceType: "PURCHASE",
      referenceId: 206,
      paymentMode: "BANK_TRANSFER"
    },
    {
      ...
      type: "RECEIVED",
      amount: 4700.0,
      paymentReference: "INV-1010",
      remark: "Sale invoice payment",
      referenceType: "SALE",
      referenceId: 110,
      paymentMode: "UPI"
    },
    {
      ...
      type: "PAID",
      amount: 1350.0,
      paymentReference: "EXP-3004",
      remark: "Utility expense",
